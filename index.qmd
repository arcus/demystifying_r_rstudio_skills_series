---
title: "Demystifying R and RStudio Skills Series"
format: html
editor: visual
---
...
- Watch a [recording](https://www.youtube.com/watch?v=ECYd7eipSeg)
...
**(Note: These are in the past, stay tuned for future programming!)**
...
All of the material in the [GitHub repository](https://github.com/arcus/demystifying_r_rstudio_skills_series) for the workshop series called **Demystifying R and RStudio**, given at the Children's Hospital of Philadelphia (CHOP) by Arcus Education is copyrighted under the [Creative Commons BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) copyright to make the material easy to reuse. 
